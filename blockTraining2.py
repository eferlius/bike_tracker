# -*- coding: utf-8 -*-
"""
Created on Wed Mar 22 23:54:01 2023
...
class Block:
    ...
    def __init__(self, duration, power = 0, speed = 0, cadence = 0, heart_rate = 0):
        self.duration = duration
        self.params = [power, speed, cadence, heart_rate]
...
class Training:
    ...
    def to_csv(self, CSVfilePath):
        ...
        rows = []
        rows.append(['start time [s]', 'param [W]'])
